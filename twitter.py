        ...
        for i in range(iteration+1):
            ...
            for tweets in user_timeline:
                ...
                if (tweets.lang in languages):
                    d = {'id_user': tweets.user.id_str, 'text': tweets.text, 'lang':tweets.lang, 'favourite_count': tweets.favorite_count, 'retweet_count': tweets.retweet_count, 'create_at': tweets.created_at, 'mentions': tweets.entities['user_mentions'], 'id_tweet':tweets.id_str, 'id_experiment': [id_experiment], 'coordinates':tweets.coordinates}
